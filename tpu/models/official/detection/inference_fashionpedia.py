  ...
  with tf.Graph().as_default():
    ...
    with tf.Session() as sess:
      ...
      for i, image_file in enumerate(image_files):
        ...
        print(' - Available prediction keys:', list(predictions_np.keys()))
        ...
        np_attributes = predictions_np['detection_attributes'][
            0, :num_detections, :]
        np_masks = None
        print(' - masks shape:', predictions_np['detection_masks'].shape)
        ...
        print(' - np_masks is None:', np_masks is None)
        if np_masks is not None: print(' - np_masks shape:', np_masks.shape)
        image_with_detections = (
            visualization_utils.visualize_boxes_and_labels_on_image_array(
                ...
                np_scores,
                label_map_dict,
                instance_masks=(np_masks > 0.5).astype(np.uint8) if np_masks is not None else None,
